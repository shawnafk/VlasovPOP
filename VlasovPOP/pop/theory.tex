...
\if{0}
Moreover, the integral can be further reduced using integration by parts, 
\begin{equation}
    \begin{aligned}
...
%The detailed derivation is given in appendix~\ref{ap.wave}
%How to solve in the framework/groundwork above
...
%\left(\mathbf{k}_i \mathbf{k}_i + k_i^2 \bfI +\frac{\omega_i^2}{c^2} \epsilon\right) \mathbf{a}_i
